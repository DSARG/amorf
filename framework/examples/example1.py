...
reg = nn.NeuralNetRegressor(
    model, patience=5, learning_rate=0.01,training_limit=10000)
reg.fit(X_train, y_train)
res = reg.predict(X_test)

print(average_relative_root_mean_squared_error(torch.from_numpy(res), torch.from_numpy(y_test))) 
